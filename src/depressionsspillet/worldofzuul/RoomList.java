...
public class RoomList {
    ...
    public static void listRooms() {
        ...
        fridayBar = new Room("Wuhuu it is friday on SDU and you suddenly feel your spirite soaring and you feel like getting smashed and so you do... You feel great.", "fridayBar");
